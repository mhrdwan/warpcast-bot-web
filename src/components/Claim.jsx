            ...
            <div className='flex justify-center items-center  bg-gray-600 '>
                <div className='w-full max-w-xs'>
                    ...
                    <textarea
                        ...
                        placeholder='Masukkan token di sini, pisahkan dengan baris baru '
                        rows="4"
                    />
                    <button
                    ...
                    {valueSelectMenu.toLocaleLowerCase() === "claim" && (
                        <>
                            ...
                            <div className='mt-5 flex justify-center space-x-4 items-center mx-3'>
                                ...
                                <button onClick={() => { setDataConfersession([]); setUpdatedDataConfersession([]) }} className='h-9 border border-red-500 rounded-md bg-red-500 p-2 focus:outline-none text-[0.8rem]  md:text-base'>Hapus Thread</button>
                            </div>
